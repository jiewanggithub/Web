...
const helicoords = new Float32Array([
  ...
  0, body, 0,
  0, -body, 0,
  wingWidth, 0, -wingLength,
  0, wingWidth, -wingLength,
  -wingWidth, 0, -wingLength,
  0, -wingWidth, -wingLength,
  0, 0, -tailLength,
]);
...
const helifaces = [
  ...
  6, 10, 7,
    ...
    //
    this.altitude = params.altitude || 30;
      ...
      switch (this.state) {
        ...
        case 1: // ascend to altitude
          ...
          if (this.helicopter.position.y >= this.altitude) {
            ...
            // console.log(this.helicopter.position.y);
            this.state = 4;
        ...
        case 2: // descend
          this.helicopter.position.y -= deltaSlowed;
          if (this.helicopter.position.y <= 20) {
            this.helicopter.position.y = 20;
            this.state = 3;
